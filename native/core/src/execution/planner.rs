...
impl PhysicalPlanner {
    ...
    pub fn query_context_registry(&self) -> &Arc<datafusion_comet_spark_expr::QueryContextMap> {
    ...
    fn create_agg_expr(
        ...
        aggregate_registry::AggregateExpressionRegistry::global()
            .create_agg_expr(spark_expr, schema, self)
    }
